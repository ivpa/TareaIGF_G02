...
<%@page import="sv.edu.ues.igf115.clave02.negocio.CtrlTipoDescuento"%>
...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    	...
    	BigDecimal porcentajedescuento = new BigDecimal(request.getParameter("porcentajedescuento"));
    	...
    	fecha=formatoDelTexto.parse(fechaString);
    	 String mensaje="";
    	 TipoDescuento tipodescuento = new TipoDescuento(id,descripcion,porcentajedescuento,fecha);
    	 CtrlTipoDescuento ctrl= new CtrlTipoDescuento();
    	 if(ctrl.crearTipoDescuento(tipodescuento))
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Crear Tipo Descuento
                            </li>
                        </ol>
                    </div>
                </div>
