...
<%
	...
	TipoDescuento tipo = new TipoDescuento(id,descripcion,porcentaje,fecha);
	CtrlTipoDescuento ctrl = new CtrlTipoDescuento();
	String mensaje="";
	if(ctrl.actualizarTipoDescuento(tipo))
		mensaje = "Se actualizo con extio";
	else
		mensaje = "Id tipo descuento no existe";
%>    
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i>Modificar  Tipo descuento
                            </li>
                        </ol>
                    </div>
                </div>
