...
<%
	String mensaje="<table class=\"table\" ><tr><b>"+"<td>id BoletaPago</td> "+"<td>Periodo </td>"+"<td>Sueldo </td>"+"<td> Id Empleado </td>"+"</b> </tr>" ;

	CtrlBoletaPago ctrl = new CtrlBoletaPago(); 
	List<BoletaPago> listaBoletaPago = ctrl.listaBoletaPagos();
	
	int numeroBoletaPago = listaBoletaPago.size();
	
	if(listaBoletaPago.isEmpty())
		mensaje = "No hay BoletaPagos";
	else
	{
		BoletaPago BoletaPagoActual;
		for(int i=0;i<numeroBoletaPago;i++){
			BoletaPagoActual = (BoletaPago)listaBoletaPago.get(i);
			mensaje+="<tr>"+"<td>"+BoletaPagoActual.getId()+"</td>"+"<td>"+BoletaPagoActual.getPeriodoPago()+"</td> "
					+"<td>"+BoletaPagoActual.getSueldoNeto()+"</td>"+"<td>"+BoletaPagoActual.getIdEmpleado().getId()+"</td>"
					+"</td> </tr>";
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="BoletaPago.html">Boleta Pago</a>
                            </li>
                            <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i>Mostrar  BoletaPago
                            </li>
                        </ol>
                    </div>
                </div>
