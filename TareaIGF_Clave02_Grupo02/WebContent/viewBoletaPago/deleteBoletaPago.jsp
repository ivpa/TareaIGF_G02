...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%
 	...
 	if(ctrl.eliminarBoletaPago(id))
 		mensaje="El BoletaPago fue eliminado con exito";
 	else
 		mensaje = "El BoletaPago no existe";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i>Eliminar  BoletaPago
                            </li>
                        </ol>
                    </div>
                </div>
