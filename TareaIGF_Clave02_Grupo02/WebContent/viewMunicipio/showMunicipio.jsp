...
<%
	String mensaje="<table class=\"table\" ><tr><b>"+"<td>id Municipio</td> "+"<td>Nombre</td> "+"<td>Departamento </td>"+"</b></tr>";

	CtrlMunicipio ctrl = new CtrlMunicipio(); 
	List<Municipio> listaMunicipio = ctrl.listaMunicipios();
	
	int numeroMunicipio = listaMunicipio.size();
	...
	else
	{
		...
		for(int i=0;i<numeroMunicipio;i++){
			MunicipioActual = (Municipio)listaMunicipio.get(i);
			mensaje+="<tr>"+"<td>"+MunicipioActual.getId()+"</td>"+"<td>"+MunicipioActual.getNombre()+"</td> "
					+"<td>"+MunicipioActual.getDepartamento().getId()+"</td></tr>"
					;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i>Mostrar  Municipios
                            </li>
                        </ol>
                    </div>
                </div>
